...
*/
  ...
  var $author$project$Elm$main = A3(
    $elm$html$Html$node,
    "html",
    _List_Nil,
    _List_fromArray([
      A3(
        ...
        _List_fromArray([
          A3(
            ...
            "style",
            _List_Nil,
            _List_fromArray([$elm$html$Html$text("span { color: red }")])
          ),
        ])
      ),
      A3(
        ...
        _List_fromArray([
          A2(
            ...
            _List_Nil,
            _List_fromArray([
              $elm$html$Html$text("Help I'm an Elm trapped inside a shadow"),
            ])
          ),
        ])
      ),
  ...
  _Platform_export({
    Elm: { init: _VirtualDom_init($author$project$Elm$main)(0)(0) },
  });
})(this);
